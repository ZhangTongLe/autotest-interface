...
public class ExcelUtil {
     ...
     * @return
     */
    public static Boolean isHSS(String filePath) {
        if (!isExcel(filePath)) {
            return null;
        }
    ...
    public List<List<String>> read() throws Exception {
        return read(getSheet(0), 0, getRowCount(0) - 1);
    }
    ...
    public List<List<String>> read(int sheetIx) throws Exception {
        return read(getSheet(sheetIx), 0, getRowCount(sheetIx) - 1);
    }

    public List<List<String>> read(String sheetName) throws Exception {
        return read(getSheet(sheetName), 0, getRowCount(sheetName) - 1);
    }
    ...
    public List<List<String>> read(int sheetIx, int start, int end) throws Exception {
        return read(getSheet(sheetIx), start, end);
    }

    public List<List<String>> read(String sheetName, int start, int end) throws Exception {
        return read(getSheet(sheetName), start, end);
    }
     ...
     * @throws Exception
     */
    public List<List<String>> read(Sheet sheet, int start, int end) throws Exception {
        List<List<String>> list = new ArrayList<List<String>>();

        if (end > getRowCount(sheet)) {
            end = getRowCount(sheet);
        }
    ...
    public int getRowCount(int sheetIx) {
        return getRowCount(getSheet(sheetIx));
    }
    ...
    public int getRowCount(String sheetName) {
        return getRowCount(getSheet(sheetName));
    }
    ...
    public int getColumnCount(int sheetIx, int rowIndex) {
        return getColumnCount(getSheet(sheetIx), rowIndex);
    }

    public int getColumnCount(String sheetName, int rowIndex) {
        return getColumnCount(getSheet(sheetName), rowIndex);
    }
     ...
     * @return
     */
    public Sheet getSheet(int sheetIx) {
        return workbook.getSheetAt(sheetIx);
    }
     ...
     */
    public Object[][] toArray(String caseName, int start, int end) throws FileNotFoundException {
        return toArray(getSheet(caseName), start, end);
    }

    public Object[][] toArray(int sheetIx, int start, int end) throws FileNotFoundException {
        return toArray(getSheet(sheetIx), start, end);
    }

    public Object[][] toArray() throws FileNotFoundException {
        return toArray(getSheet(0), 0, getRowCount(0) - 1);
    }

    public Object[][] toArray(String sheetName) throws FileNotFoundException {
        return toArray(getSheet(sheetName), 0, getRowCount(sheetName) - 1);
    }

    public Object[][] toArray(int sheetIx) throws FileNotFoundException {
        return toArray(getSheet(sheetIx), 0, getRowCount(sheetIx) - 1);
    }

    public Object[][] toArray(String sheetName, int start) throws FileNotFoundException {
        return toArray(getSheet(sheetName), start, getRowCount(sheetName) - 1);
    }

    public Object[][] toArray(int sheetIx, int start) throws FileNotFoundException {
        return toArray(getSheet(sheetIx), start, getRowCount(sheetIx) - 1);
    }
     ...
     * @throws FileNotFoundException
     */
    public Object[][] toArray(Sheet sheet, int start, int end) throws FileNotFoundException {
        List<List<String>> rsList = null;
        Object[][] ret = null;
        try {
            rsList = read(sheet, start, end);
            ret = new Object[rsList.size()][];
            for (int i = 0; i < rsList.size(); i++) {
                ret[i] = rsList.get(i).toArray(new Object[rsList.get(i).size()]);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
